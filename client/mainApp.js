...
myApp.config(['$routeProvider',function($routeProvider){
	...
	.when('/employeeRegister',{templateUrl: 'employeeRegister.html',controller: 'employeeRegisterController'})
	.when('/employeeProfile',{templateUrl: 'views/employeeProfile.html',controller: 'employeeProfileController'})
	.when('/companyRegister',{templateUrl: 'companyRegister.html',controller: 'companyRegisterController'})
	.when('/companyProfile',{templateUrl: 'views/companyProfile.html',controller: 'companyProfileController'})
	...
	.when('/forgotten',{templateUrl: '/forgotten.html',controller: 'ContactController'})
	.when('/forgotten-success',{templateUrl: 'views/forgotten-success.html',controller: 'ContactController'})
	...
	.when('/removeCompany',{templateUrl: 'views/removeCompany.html',controller: 'companyRegisterController'})
	.when('/removeEmployee',{templateUrl: 'views/removeEmployee.html',controller: 'employeeRegisterController'})
